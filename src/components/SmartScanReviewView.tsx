    ...
    <div className="bg-[#181818] border border-[#2c2c2c] rounded-3xl p-5 sm:p-7 shadow-2xl space-y-6 animate-in fade-in duration-200">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-6 border-b border-[#282828]">
        ...
        <div className="flex flex-wrap items-center gap-2.5 shrink-0">
          {onOpenSummary && (
            <button
              id="reopen-summary-modal-btn"
              onClick={onOpenSummary}
              className="px-3.5 py-2.5 rounded-xl bg-[#222222] hover:bg-[#2c2c2c] border border-[#383838] text-[#C9A86A] text-xs font-semibold flex items-center justify-center gap-1.5 transition-colors cursor-pointer min-h-[44px]"
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 self-end sm:self-auto">
                      {onOpenQuickView && (
                        <button
                          type="button"
                          onClick={() => onOpenQuickView(match.targetFile, match)}
                          className="px-2.5 py-1 rounded-lg bg-[#222222] hover:bg-[#2c2c2c] border border-[#383838] text-[#F5E9DC] hover:text-[#C9A86A] text-[11px] font-medium flex items-center gap-1 cursor-pointer transition-colors"
                          title="Quick View snippet & modified date"
                        >
                          <Eye className="w-3 h-3 text-[#C75B12]" />
                      ...
                      <div className="flex items-center gap-2 self-end sm:self-auto">
                        {onOpenQuickView && (
                          <button
                            type="button"
                            onClick={() => onOpenQuickView(match.targetFile, match)}
                            className="px-2.5 py-1.5 rounded-xl bg-[#222222] hover:bg-[#2c2c2c] border border-[#383838] text-[#F5E9DC] hover:text-[#C9A86A] text-xs font-semibold flex items-center gap-1 cursor-pointer transition-colors"
                            title="Quick View snippet & modified date"
                          >
